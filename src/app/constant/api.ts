...
export enum ApiPath {
  ...
  ApiPublicQuestGroupList = '/api/public/quest/group-list',
  ApiNsCheckLogin = '/api/ns/check-login',
  ApiNsMarquees = '/api/ns/marquees',
  ApiLetterAnnouncementRead = '/api/letter/announcement/read',
  ApiLetterAnnouncementRemove = '/api/letter/announcement/remove',
  ...
  ApiMemberQuestListApplied = '/api/quest/list/applied',
  ...
  ApiMemberDepositBankSettingCheck = '/api/member/deposit/bank-setting/check'
